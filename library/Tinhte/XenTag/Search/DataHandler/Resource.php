...
class Tinhte_XenTag_Search_DataHandler_Resource extends XenForo_Search_DataHandler_Abstract {
	...
	protected function _insertIntoIndex(XenForo_Search_Indexer $indexer, array $data, array $parentData = null) {
		...
		if (isset($data[Tinhte_XenTag_Constants::FIELD_RESOURCE_TAGS])) {
			...
			$tags = Tinhte_XenTag_Helper::unserialize($data[Tinhte_XenTag_Constants::FIELD_RESOURCE_TAGS]);
		} else {
			$tags = array();
		}
		...
		$indexer->insertIntoIndex(
			Tinhte_XenTag_Constants::CONTENT_TYPE_RESOURCE, $data['resource_id'],
	...
	public function getDataForResults(array $ids, array $viewingUser, array $resultsGrouped) {
		$resources = $this->_getResourceModel()->getResourcesByIds(
			$ids,
			array(
